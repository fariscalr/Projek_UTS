...
import com.fariscal_ramadhan.databinding.ActivityMapsWisataBinding;
...
public class MapsWisata extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng location = new LatLng(-8.542003877448051, 116.24127481403026);
        mMap.addMarker(new MarkerOptions().position(location).title("Taman Wisata Sesaot"));
