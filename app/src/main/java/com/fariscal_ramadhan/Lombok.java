...
public class Lombok extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] values = new String[]{"Bukit Pergasingan", "Taman Wisata Sesaot",
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 1) {
                    Intent myIntent = new Intent(view.getContext(), Wisata.class);
                    startActivityForResult(myIntent, 0);
                }
                if (position == 2) {
                    Intent myIntent = new Intent(view.getContext(), Terjun.class);
                    startActivityForResult(myIntent, 0);
                }
